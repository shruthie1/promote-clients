...
export class Promotion {
    private promotionResults: Map<string, { success: boolean, errorMessage?: string }> = new Map();
    ...
    public setPromotionResults(promotionResults: Record<string, { success: boolean, errorMessage?: string }>) {
